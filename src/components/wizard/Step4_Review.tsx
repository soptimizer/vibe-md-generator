...
import {
  ...
  FileText, FileJson, GitBranchPlus, CheckCircle2, Download
} from 'lucide-react';
  ...
  return (
    <div className="flex flex-col gap-5 rounded-2xl border border-border/60 bg-card p-5 shadow-xl shadow-black/30">
      ...
      <div className="flex items-center gap-3">
        <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-primary/15 border border-primary/25 text-sm font-bold text-primary">4</span>
        <div>
